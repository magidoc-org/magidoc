...
Choice of template and package manager are available when initializing a project. The recommended default package manager is [Pnpm](https://pnpm.io/workspaces).`;export{e as default};
